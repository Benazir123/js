...
export default defineComponent({
  ...
  data() {
    return {
      ...
      seriesEngagementStatuskol: [44, 55, 41, 17, 15],
      chartOptionsEngagementStatusKol: {
        chart: {
          type: 'donut',
        },
        plotOptions: {
      ...
      seriesFinancialReportkol: [
        {
          data: [80, 180, 120, 50, 130, 100],
        },
      ],
      chartOptionsFinancialReportkol: {
        chart: {
          height: 350,
          type: 'bar',
        },
      ...
      chartOptionsProgramByRegionkol: {
        chart: {
          type: 'bar',
          height: 350,
        },
      ...
      seriesTotalAttendessKol: [35, 45, 30, 20],
      chartOptionsTotalAttendessKol: {
        chart: {
          type: 'pie',
          width: 600,
        },
