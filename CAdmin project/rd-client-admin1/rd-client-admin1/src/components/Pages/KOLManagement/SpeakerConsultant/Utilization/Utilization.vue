          ...
          <div class="flex justify-between">
            ...
            <div class="w-spright">
              ...
              <div class="flex flex-nowrap scroller gap-4 mt-8 pb-4 mb-2">
                <div
                  class="flex items-center justify-between border border-1.0263px rounded-radius40 p-4 border-searchbox w-300px flex-none"
                >
                  <div>
                ...
                >
                  <div>
                    ...
                    <b class="text-fs20 font-bold text-greenclr mt-2 block">$85,000</b>
                  </div>
                  <img src="@/assets/utilized.svg" />
                </div>
                <!-- <div class="flex items-center justify-between border border-1.0263px rounded-radius40 p-4 border-searchbox w-300px flex-none">
                  <div>
                    <h3 class="text-fs13 font-semibold text-greytxt">SOFT CAP</h3>
                    <b class="text-fs20 font-bold text-darkpink mt-2 block">178%</b>
                  </div>
                ...
                >
                  <div>
                    ...
                    <b class="text-fs20 font-bold text-yellow mt-2 block">$1,15,000</b>
                  </div>
                  <img src="@/assets/remaining.svg" />
                </div>
                <!-- <div class="flex items-center justify-between border border-1.0263px rounded-radius40 p-4 border-searchbox w-300px flex-none">
                  <div>
                    <h3 class="text-fs13 font-semibold text-greytxt">REMAINING SOFT CAP</h3>
              ...
              <div class="flex flex-wrap">
                <div class="w-full">
                  <div class="flex justify-between items-center relative">
                    ...
                    <div class="relative">
                      <div
                        class="cursor-pointer flex float-right cursor-pointer bg-graymenu shadow-filtershadow relative rounded-radius4 text-fs13 text-greytxt px-7 py-3.5"
                        @click="showFilter()"
                      >
                        ...
                        <ul
                          v-if="filterPop"
                          class="bg-white w-full absolute right-0 top-full border border-spkfilterborder rounded-radius5 z-10 shadow-filtershadow"
                        >
      ...
      <div>This is the Popper content</div>
                      ...
                      <td>5%</td> -->
                            ...
                            <tr v-if="showfirstchild5 && showfirstchild3 && showfirstchildren" class="child4">
                              <td>
                                <div class="flex items-center">
                                  John James 17JAN2021 HCP Work Order 3 (Peds Ad Board)
                                </div>
                              </td>
                              <td>Adtralza</td>
                              <td>-</td>
                      ...
                      <td>15%</td> -->
                            ...
                            <tr v-if="showfirstchild5 && showfirstchild3 && showfirstchildren" class="child4">
                              <td>
                                <div class="flex items-center">
                                  James Antony 25NOV2021 HCP Work Order 3 (Peds Ad Board)
                                </div>
                              </td>
                              <td>DSA</td>
                              <td>-</td>
                      ...
                      <div class="vue-world-map">
                        ...
                        >
                          ...
                          <div class="vue-map-legend-content bg-white p-0 pt-4 mt-2 border-companyinputbox">
                            <div>
                              <h3
                                class="flex items-center justify-between text-fs12 text-maptooltipcon font-semibold cursor-pointer"
...
<script lang="ts" src="./Utilization.ts"></script>
<style>
:root {
