                ...
                <div class="w-full">
                  ...
                  <div class="tab-content tab-space mt-8">
                    ...
                    >
                      ...
                      <div v-if="showPopover" class="fixed z-40 top-0 bottom-0 left-0 right-0" @click="hidetooltip()"></div>
                      ...
                      >
                        ...
                        <p class="text-fs13 text-formlabel font-normal mt-3">
                          Vyzulta is specifically indicated for the reduction of intraocular pressure (IOP) in patients with
